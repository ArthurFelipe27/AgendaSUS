document.addEventListener('DOMContentLoaded', () => {
    ...
    async function handleCadastroMedicoSubmit(event) {
        ...
        try {
            ...
            if (response.ok) { showToast('Médico cadastrado com sucesso!', 'success'); renderFormCadastroMedico(); }
    ...
    async function handleDesativarUsuario(userId) {
        try {
            ...
            if (response.ok) { showToast('Usuário desativado com sucesso!', 'success'); renderGerenciadorDeUsuarios(); }
